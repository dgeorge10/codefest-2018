...
var _RideEstimatesSearch = require('../RideEstimatesSearch');

var _RideEstimatesSearch2 = _interopRequireDefault(_RideEstimatesSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var RideEstimatesSearchBuilder = function () {
  function RideEstimatesSearchBuilder() {
    _classCallCheck(this, RideEstimatesSearchBuilder);
  }

  _createClass(RideEstimatesSearchBuilder, null, [{
    key: 'build',
    value: function build(json) {
      ...
      if ('rideType' in json) {
        var rideType = RideEstimatesSearchBuilder.validateRideType(json['rideType']);
        args = args.set('rideType', rideType);
      }

      return new _RideEstimatesSearch2.default(args);
    }
  }, {
  ...
  return RideEstimatesSearchBuilder;
}();

exports.default = RideEstimatesSearchBuilder;